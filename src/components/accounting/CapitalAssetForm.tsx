...
export default function CapitalAssetForm({ onBack, onSave }: CapitalAssetFormProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold">Capital Asset Purchase</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Capital Asset Details</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Enter asset name (e.g., Computer, Machinery)"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Enter quantity with unit (e.g., 2 units)"
                  required
                />
              </div>
