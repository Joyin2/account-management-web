...
export default function RawMaterialForm({ onBack, onSave }: RawMaterialFormProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold">Raw Material Purchase</h1>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Enter quantity with unit (e.g., 100 kg)"
                  required
                />
              </div>
